    ...
    datasets: [
      {
        ...
        fill: false,
        borderColor: 'rgb(54, 162, 235)', // Different color for differentiation
        tension: 0.1
      }
    ]
  };
          ...
          <div className="card-body">
            <div className="row align-items-center">
              <div className="col-lg-5 d-flex d-lg-block justify-content-between align-items-center">
                ...
                <h5>$543.21</h5> {/* Different value to show it's a different metric */}
              </div>
...
export default ChartSalesComponents;
